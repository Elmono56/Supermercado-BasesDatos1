...
BEGIN
    ...
    SELECT 
    DINERO_FACTURADO + PEDIDO_PRODUCTO.CANTIDAD_PRODUCTO * BODEGA_SUCURSAL_PRODUCTO.PRECIO_COMPRA
...
BEGIN
	IF (DIAS_CADUCIDAD_PRODUCTO(COD_PRODUCTO) < 0) THEN
		CALL CRUD_PRODUCTO_EXPIRADO ( COD_PRODUCTO, 
									(SELECT NOMBRE_PRODUCTO FROM PRODUCTO WHERE COD_PRODUCTO = PRODUCTO.COD_PRODUCTO),
                                    (SELECT FECHA_VENCIMIENTO FROM BODEGA_SUCURSAL_PRODUCTO WHERE COD_PRODUCTO = BODEGA_SUCURSAL_PRODUCTO.COD_PRODUCTO), 'CREATE');
...
BEGIN
	SELECT 
        ...
        FECHA_EXPIRADO AS 'FECHA EXPIRADO'
    FROM PRODUCTO_EXPIRADO;
END
//
